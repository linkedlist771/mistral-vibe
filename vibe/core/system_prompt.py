...
def _add_commit_signature() -> str:
    return (
        ...
        "It will always be suffixed with a line telling it was generated by Claude Code with the appropriate co-authoring information.\n"
    ...
    *,
    ...
    if config.include_project_context:
        ...
        try:
            ...
            mem_section = get_memory_store().build_prompt_section()
        except Exception:
            mem_section = ""
        if mem_section:
